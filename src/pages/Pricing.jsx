        ...
        <div className={styles.tierWrapper}>
          ...
          <div className={styles.tireCard}>
            ...
            <div className={styles.tireListContainer}>
              ...
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Multilingual (DE/EN)</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
          ...
          <div className={styles.tireCard}>
            ...
            <div className={styles.tireListContainer}>
              ...
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Gamification & quizzes</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
          ...
          <div className={styles.tireCard}>
            ...
            <div className={styles.tireListContainer}>
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Unlimited POIs & trails</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>In-app monetization (ads/tickets)</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Dual-mode: Citizen/Tourist</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Regional CMS API integration</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
                <div className={styles.tireListPara}>Dedicated Account Manager</div>
              </div>
              <div className={styles.tireList}>
                <span> &#10003; </span>
